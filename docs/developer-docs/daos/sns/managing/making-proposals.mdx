...
:::warning
Most proposals can be submitted at any time. However, some proposals are not allowed until the swap has finished:

1. Manage Nervous System Parameters
2. Transfer Sns Treasury Funds
3. Mint Sns Tokens
4. Upgrade Sns Controlled Canister
5. Register Dapp Canisters
6. Deregister Dapp Canisters
